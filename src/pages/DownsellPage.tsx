...
const DownsellPage = () => {
  ...
  const handleAccept = () => {
    // Logic to add downsell product to order
    const downsellProduct = {
      id: 'downsell-1',
      name: 'Blusa Básica Blanca',
      price: 18.00, // Discounted from 25
      quantity: 1,
    ...
    const updatedOrder = {
      ...order,
      items: [...order.items, downsellProduct],
      total: order.total + downsellProduct.price
    };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-2xl w-full space-y-8 bg-white p-8 rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900">¿Qué tal solo una?</h2>
          <p className="mt-2 text-lg text-gray-600">
            Entendemos que no quieras el pack completo. ¿Te gustaría llevarte solo una blusa básica a un precio especial?
          </p>
        </div>
        ...
        <div className="border-2 border-dashed border-red-200 bg-red-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Blusa Básica Blanca</h3>
              <p className="text-gray-600 mb-4">
                La prenda más versátil de tu armario. Algodón pima 100%, corte perfecto.
              </p>
              <div className="flex items-center justify-center md:justify-start gap-4 mb-4">
                <span className="text-gray-400 line-through text-lg">$25.00</span>
                <span className="text-3xl font-bold text-red-600">$18.00</span>
                <span className="bg-red-100 text-red-800 text-xs font-bold px-2 py-1 rounded">AHORRAS 28%</span>
              </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            SÍ, AGREGAR A MI PEDIDO POR $18.00
          </button>
          <button
